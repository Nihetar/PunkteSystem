...
import { getAllSchwimmer, updateSchwimmer } from '../SchwimmerApi';
...
export function UpdatePage() {
  ...
  useEffect(() => {
    getAllSchwimmer().then(res => setRows(res.data));
  }, []);
  ...
  const handleCellChange = (
    ...
    setRows(updated);
    const { name, ...flags } = updated.find(r => r.id === id)!;
    updateSchwimmer(id, { name, ...flags });
  };
